...
class CertificateManager:
    ...
    def setup_certificate(self, cert_path: str, cert_password: str) -> Tuple[str, str]:
        ...
        try:
            ...
            print(f"[jira-mcp] Certificate extracted successfully from {cert_path}")
    ...
    def cleanup(self):
        ...
        for temp_file in self.temp_files:
            try:
                ...
                print(f"[jira-mcp] Warning: Could not delete temporary file {temp_file}: {e}")
...
def validate_openssl_available() -> bool:
    ...
    try:
        ...
        print(f"[jira-mcp] OpenSSL is available: {version}")
        return True
    except (subprocess.CalledProcessError, FileNotFoundError):
        print("[jira-mcp] OpenSSL is not available on the system")
        return False
